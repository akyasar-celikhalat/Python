...
SAYFA_GENİŞLİĞİ_MM = 85  # Örnek: 100 mm
SAYFA_YÜKSEKLİĞİ_MM = 120  # Örnek: 150 mm
...
def generate_barcodes():
    ...
    try:
        ...
        max_barcode_height = page_height / 3  # Sayfanın 1/4'ü kadar yükseklik
        ...
        for num in range(start_num, end_num + 1):
            ...
            c.setFont("Helvetica", 10)  # Varsayılan font ve boyutu ayarla
