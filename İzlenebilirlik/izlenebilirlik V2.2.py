...
product_times = {}
product_processes = {}
product_tuketim = {}  # Tüketim bilgilerini saklamak için yeni bir sözlük eklendi
...
for row in df.values:
    ...
    if çıkış_barkod not in product_machines:
        ...
        product_tuketim[çıkış_barkod] = tuketim  # Tüketim bilgisi kaydedildi
...
def build_traceability_tree(product_code, root_code, graph, depth=0, process_chain=None):
    ...
    tuketim = product_tuketim.get(product_code, "")  # Tüketim bilgisi alındı
    ...
    result.append({
        ...
        'Makine': makine,
        'Tüketim (Kg)': tuketim,  # Tüketim bilgisi eklendi
