...
def track_production_backwards(file_path, search_term):
    ...
    if not result_df.empty:
        # Sıralama: Önce İşlem Döngüsündeki adım sayısına göre (azdan çoğa), 
        # sonra da işlem döngüsünün içeriğine göre (alfabetik)
        # Bu, en kısa zincirlerin (ham maddeler) en başta, daha uzun zincirlerin (son ürünler) sonda olmasını sağlar.
        # Ancak, aynı zamanda zincir içindeki sıralamayı da korur.
        # En basit ve doğru yol: Sadece İşlem Döngüsü string'ine göre sıralamak.
