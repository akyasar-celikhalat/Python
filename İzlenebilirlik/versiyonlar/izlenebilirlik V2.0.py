...
# Ana ürün kodunu bulma ve işleme
def process_product_codes(base_product_code):
...
# Ana ürün kodunu belirtme
base_product_code = '77359201'

# Ağacı oluştur ve sonuçları birleştirme
trace_data = process_product_codes(base_product_code)
...
if trace_data:
    ...
    output_file = f'izlenebilirlik_{base_product_code}.xlsx'
    ...
    print("Belirtilen ana ürün kodu için veri bulunamadı.")